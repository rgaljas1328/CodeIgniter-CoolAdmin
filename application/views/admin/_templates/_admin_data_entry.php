...
<li class="<?=active_link_controller('salaries')?>">
    <a href="<?php echo site_url('admin/salaries'); ?>">
        <i class="fa fa-money"> </i><span> <?php echo lang('menu_salaries'); ?></span>
    </a>
</li>
<li class="<?=active_link_controller('log_time')?>">
    <a href="<?php echo site_url('admin/log_time'); ?>">
        <i class="fa fa-money"> </i><span> <?php echo lang('menu_log_time'); ?></span>
    </a>
</li>
<li class="<?=active_link_controller('time_salaries')?>">
    <a href="<?php echo site_url('admin/time_salaries'); ?>">
        <i class="fa fa-money"> </i><span> <?php echo lang('menu_time_salaries'); ?></span>
    </a>
</li>
